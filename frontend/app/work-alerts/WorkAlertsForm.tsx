        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <fieldset className="border border-line rounded-lg p-4 space-y-3">
            ...
            <label className="flex items-start gap-3 text-sm text-body">
              ...
              <span>
                Text me job alerts
                <span className="ml-2 align-middle font-mono text-[12px] uppercase tracking-wider text-accent-text-hover bg-accent/10 border border-accent/30 rounded px-1.5 py-0.5">
