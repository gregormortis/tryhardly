    ...
    <div className="min-h-screen bg-canvas py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-body space-y-6 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-4">What&apos;s welcome on TryHardly</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-4">Services we don&apos;t allow</h2>
            <p className="mb-4">
              You may not offer, request, or arrange any of the following on TryHardly:
            </p>

            <h3 className="text-lg font-semibold text-strong mb-1">Illegal services</h3>
            <p className="mb-4">
              Anything that breaks federal, state, or local law, or that helps someone else break
              the law.
            </p>

            <h3 className="text-lg font-semibold text-strong mb-1">Adult or sexual services</h3>
            <p className="mb-4">
              Escort or companionship-for-pay arrangements, sexual services, adult entertainment,
              or sexually explicit content of any kind.
            </p>

            <h3 className="text-lg font-semibold text-strong mb-1">Gambling, betting, and wagering</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Weapons, firearms, explosives, and dangerous materials</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Medical and healthcare services requiring licensure</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Legal services requiring attorney licensure</h3>
            <p className="mb-4">
              Legal advice, representation, or document preparation that legally requires a licensed
              attorney.
            </p>

            <h3 className="text-lg font-semibold text-strong mb-1">Government, identity, and document services</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Travel booking, freight forwarding, and shipping broker services</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Intellectual property infringement</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-strong mb-1">Deceptive, fraudulent, or abusive work</h3>
            <p className="mb-4">
              Scams, fake reviews, impersonation, phishing, harassment, or any task designed to
              deceive, defraud, or harm another person.
            </p>

            <h3 className="text-lg font-semibold text-strong mb-1">Unsafe work requiring licenses, permits, or insurance</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-4">Questions or reports</h2>
            <p>
