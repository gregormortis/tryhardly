...
// Body copy face. Syne is a display type — characterful in headings, tiring
// in paragraphs. Inter is a humanist sans designed for UI text and reads well
// at small sizes, which matters for an older homeowner audience.
const inter = Inter({
  subsets: ['latin'],
  display: 'swap',
  variable: '--font-inter',
