    ...
    <div className="min-h-screen bg-canvas py-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-body space-y-6 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-3">How to request deletion</h2>
            <ul className="list-disc list-inside space-y-2 ml-1">
              <li>
                <span className="text-strong font-medium">In the app or on the web (recommended):</span> sign
                in, then use the button below or the &ldquo;Delete account&rdquo; option in your{' '}
                <Link href="/profile" className="text-accent-text hover:text-accent-text-hover">profile settings</Link>.
                Your request is logged immediately and queued for our team to review — this is the most reliable
                way to reach us.
              </li>
              <li>
                <span className="text-strong font-medium">By email:</span> you can also write to{' '}
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-3">What gets deleted</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-3">How long it takes</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-accent-text mb-3">Request deletion now</h2>
