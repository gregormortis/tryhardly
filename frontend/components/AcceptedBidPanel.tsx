...
export default function AcceptedBidPanel({
  ...
  return (
    <div className="bg-surface border border-info/40 rounded-xl p-6 space-y-5">
      <div className="flex items-start gap-3">
        <CheckCircle2 className="text-info shrink-0 mt-0.5" size={22} />
        <div>
          <h2 className="text-lg font-semibold text-strong">{nextStep.heading}</h2>
          <p className="text-sm text-muted mt-1">
            You accepted a bid from{' '}
            <span className="text-info font-medium">{workerName}</span>.{' '}
            {nextStep.detail}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-raised rounded-lg px-4 py-3">
          <div className="text-[12px] uppercase tracking-wide text-subtle">
            Selected worker
          </div>
          <div className="text-sm font-medium text-strong mt-0.5 truncate">
            {workerName}
          </div>
        </div>
        <div className="bg-raised rounded-lg px-4 py-3">
          ...
          <div className="text-sm font-semibold text-accent-text mt-0.5">
      ...
      <div className="rounded-lg border border-line bg-canvas p-4 space-y-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-raised border border-line-strong rounded-lg px-3 py-2 text-strong text-sm focus:outline-none focus:border-info"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-raised border border-line-strong rounded-lg px-3 py-2 text-strong text-sm resize-none focus:outline-none focus:border-info"
          />
        </div>
        ...
        <button
          ...
          className="w-full rounded-lg bg-raised-2 hover:bg-raised-2 disabled:opacity-50 disabled:cursor-not-allowed px-4 py-2 text-sm font-semibold text-strong transition-colors"
        >
